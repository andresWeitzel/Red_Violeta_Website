...
export class MapComponent {
  ...
  places: HelpPlace[] = [
    ...
    {
      id: 'inadi',
      name: 'INADI — Instituto Nacional contra la Discriminación, la Xenofobia y el Racismo',
      about:
    ...
    {
      id: 'ovd',
      name: 'Oficina de Violencia Doméstica (OVD) — Corte Suprema de Justicia',
      about:
